  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Text("Vip/Celebrity Plan",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
            Text("\$49.99/Month",style: TextStyle(fontSize: 17,color: Colors.white,fontFamily: ""),),
            SizedBox(height: 20,),
            Row(
