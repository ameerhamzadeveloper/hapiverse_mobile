      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text("\$2,000/Month",style: TextStyle(fontSize: 17,color: Colors.white,fontFamily: ""),),
            SizedBox(height: 20,),
            Row(
              ...
              children: [
                ...
                SizedBox(width: 10,),
                Expanded(child: Text("Sponsor 100 basic and 5 gold plans",style: TextStyle(color: Colors.white),)),
              ],
            ),
            SizedBox(height: 10,),
            Row(
